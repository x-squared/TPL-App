...
Each level must include exactly one status label.
...
- `spec/requirements/TPLK-Specification.md`
...
Rule: every Topic, Use Case, Story, and Item must carry exactly one status label.
