...
This verifies that conceptual entities/relations in `spec/domain/conceptual-domain-model.puml` still map to backend SQLAlchemy model intent, using `spec/domain/domain-sync-mapping.json`.
