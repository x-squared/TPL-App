...
def build_coordination_procurement_source() -> SourceDef:
    fields: tuple[FieldDef, ...] = (
        ...
        FieldDef("ambulance_arrival_time", "Ambulance Arrival Time", "string", ("eq", "contains"), lambda row: _iso(row.ambulance_arrival_time)),
        FieldDef("informed_time", "Informed Time", "string", ("eq", "contains"), lambda row: _iso(row.informed_time)),
        ...
        FieldDef("reached_time", "Reached Time", "string", ("eq", "contains"), lambda row: _iso(row.reached_time)),
        FieldDef("informed_implantteam_time", "Informed Implantteam Time", "string", ("eq", "contains"), lambda row: _iso(row.informed_implantteam_time)),
