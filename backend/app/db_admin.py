...
def main() -> int:
    ...
    parser.add_argument(
        "--mode",
        choices=("recreate", "migrate", "refresh", "clean", "migrate-procurement-runtime", "clear-translation-bundles"),
        default="refresh",
        help="recreate=drop/create+seed, migrate=schema only, refresh=migrate+clean+seed, clean=data only, migrate-procurement-runtime=legacy->unified procurement backfill, clear-translation-bundles=delete DB translation overrides",
    )
